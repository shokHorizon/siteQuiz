const configChatbot = {
    bot: {
      ...
      9: { content: ['Внимательно смотри видео до самого конца и отличные результаты тебе гарантированы!',['https://www.youtube.com/embed/ltMSrSis9ww'], 'После просмотра нажми на кнопку ниже:'], human: [24] },
      10: { content: ['Откуда берутся деньги и кто платит за все это?', 'В чем суть бизнеса?', 
                    'Внимательно смотри видео до самого конца и после завершения нажми кнопку под видео:', ['https://www.youtube.com/embed/ltMSrSis9ww']], human: [25]},
      ...
      14: { content: ['Отлично, сейчас я расскажу тебе, как зарабатывать такую сумму ежемесячно и даже повышать ее уровень из года в год.',
                    ...
                    'Внимательно смотри видео до самого конца:',['https://www.youtube.com/embed/ltMSrSis9ww'], 'После просмотра нажми на кнопку ниже:'], human: [28]},
      15: { content: ['Как осуществить свои мечты?', 'Как выбраться из этого замкнутого круга?', 'Внимательно смотри видео до самого конца:', ['https://www.youtube.com/embed/ltMSrSis9ww'],
